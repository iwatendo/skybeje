...
import CastInstanceModelRasPi from "./CastInstanceRasPiModel";
import CastInstanceViewRasPi from "./CastInstanceRasPiView";
import { CastInstanceReceiverRasPi } from "./CastInstanceRasPiReceiver";
...
export default class CastInstanceControllerRasPi extends AbstractServiceController<CastInstanceViewRasPi, CastInstanceModelRasPi> {
    ...
    public View: CastInstanceViewRasPi;
    ...
    constructor() {
        super();
        this.Receiver = new CastInstanceReceiverRasPi(this);
    ...
    public OnPeerOpen(peer: PeerJs.Peer) {
        this.View = new CastInstanceViewRasPi(this, () => { });
    }
